...
export default function TypingPractice5MinutePage() {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-16">
        <header className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold text-gray-900">5 Minute Typing Practice</h1>
          </div>
          {isFinished && (
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 animate-in fade-in">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full animate-in zoom-in-95 slide-in-from-bottom-4">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-500 mt-1">5 Minute Typing Practice</p>
              </div>
