...
const SAMPLE_TEXTS = [
  "The quick brown fox jumps over the lazy dog. This pangram contains every letter of the alphabet at least once. Practice makes perfect when it comes to typing speed and accuracy.",
  "Pack my box with five dozen liquor jugs. Another perfect pangram for typing practice. Consistent daily effort yields remarkable results over time.",
  "How vexingly quick daft zebras jump. Short but challenging with unusual letter combinations. Focus on rhythm and let your fingers find the keys naturally.",
  "Bright vixens jump; dozy fowl quack. A whimsical sentence to test your rhythm. The best typists make it look effortless through thousands of hours of practice.",
  "Sphinx of black quartz, judge my vow. An ancient riddle turned typing drill. Every expert was once a beginner who refused to give up.",
];

export default function TypingTest2MinutePage() {
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 animate-in fade-in">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full animate-in zoom-in-95 slide-in-from-bottom-4">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-500 mt-1">2 Minute Typing Test</p>
              </div>
