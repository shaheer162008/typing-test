...
const SAMPLE_TEXTS = [
  "The quick brown fox jumps over the lazy dog. This pangram contains every letter of the alphabet at least once. Practice makes perfect when it comes to typing speed and accuracy. Consistency is the key to mastery. Your daily dedication builds the foundation for exceptional performance.",
  "Pack my box with five dozen liquor jugs. Another perfect pangram for typing practice. Consistent daily effort yields remarkable results over time. Your fingers will remember what your mind learns. Trust the process and embrace each session.",
  "How vexingly quick daft zebras jump. Short but challenging with unusual letter combinations. Focus on rhythm and let your fingers find the keys naturally. Speed follows accuracy. Patience and persistence create champions.",
  "Bright vixens jump; dozy fowl quack. A whimsical sentence to test your rhythm. The best typists make it look effortless through thousands of hours of practice. Every keystroke counts toward your goal.",
  "Sphinx of black quartz, judge my vow. An ancient riddle turned typing drill. Every expert was once a beginner who refused to give up. Type with purpose and precision. Your journey to mastery starts now.",
];

export default function TypingTest5MinutePage() {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 md:py-16">
        <header className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold text-gray-900">5 Minute Typing Test</h1>
          </div>
          {isFinished && (
            <Link
              href="/typing-test"
        ...
        <div className="mb-8">
          <div className="flex justify-between text-sm mb-2">
            ...
            <span className="font-semibold text-[#126dfb]">
              {Math.round(((300 - timeLeft) / 300) * 100)}%
            </span>
          </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 animate-in fade-in">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full animate-in zoom-in-95 slide-in-from-bottom-4">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-500 mt-1">5 Minute Typing Test</p>
              </div>
              ...
              <div className="space-y-3">
                <button
                  onClick={restartTest}
                  className="w-full py-3 bg-[#126dfb] hover:bg-blue-600 text-white font-semibold rounded-xl transition-all"
                >
                  Try Again
                </button>
                <Link
