...
const WORD_TEXTS = [
  ...
  "speed follows accuracy patience creates champions",
  "every keystroke counts toward your goal",
  "muscle memory builds through repetition",
  "precision matters more than raw speed",
  "daily practice transforms beginners experts",
  "track progress celebrate small victories",
  "mindful typing reduces errors increases flow",
  "ergonomic posture prevents fatigue strain",
  "keyboard shortcuts boost productivity significantly",
  "touch typing unlocks true potential speed",
  "customize practice target weak areas specifically",
  "competitive spirit drives continuous improvement",
];

export default function WordTyping100WordsPage() {
  ...
  useEffect(() => {
    ...
    const selected = allWords.slice(0, 100);
    setWords(selected);
  }, []);
