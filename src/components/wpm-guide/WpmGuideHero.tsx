...
export default function WpmGuideHero() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 tracking-tight leading-[1.1] mb-6">
            Understand Your <br /> Typing Speed
          </h1>
          <p className="text-[17px] text-gray-500 leading-relaxed mb-8 max-w-lg">
            What does your WPM mean? How is it calculated? Where do you stand? Get a complete breakdown of typing speed benchmarks and real-world expectations.
          </p>
          ...
          <div className="relative rounded-[2.5rem] p-6 md:p-8 overflow-hidden bg-[#f8fafc] border border-gray-100">
            ...
            <div className="relative p-6 pb-12 rounded-2xl bg-white shadow-sm border border-gray-50">
              ...
              <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
                ...
                <span>› wpm-guide › benchmarks</span>
              </div>
              {/* Title */}
              <h4 className="text-lg md:text-xl font-bold text-[#126dfb] leading-snug mb-2">
                WPM Scale: How Fast Are You Really?
              </h4>
              {/* Description */}
              <p className="text-sm text-gray-600 leading-relaxed">
                Learn the difference between raw WPM and net WPM. Find out if your typing speed meets the standard for professional data entry and administrative roles.
              </p>
